...
<main class="skillcertify">
      ...
      <div class="hero-wrap">
        <div class="hero-row">
          <div class="sub-hero-copy">
            <p class="tag" data-i18n="skillcertify-hero-eyebrow">Assess · IT 역량 인증</p>
            <h1 class="hero-title">SkillCertify</h1>
            <p class="hero-desc" data-i18n="skillcertify-hero-desc-01">코드가 실행되는지만 보지 않습니다. <br data-break="desktop">실제 직무에서 통하는 품질까지 봅니다.</p>
            <p class="hero-desc" data-i18n="skillcertify-hero-desc-02">50개 직무의 실제 프로젝트로 성능, 코드 품질, 문제 해결 과정을 함께 평가합니다.</p>
    ...
    <section class="intro fade-up">
      <div class="section-wrap col">
        <div class="section-title text-center">
          <h2 data-i18n="skillcertify-intro-title">이런 고민을 가지고 계시다면, <br data-break="desktop">SkillCertify를 시작해보세요!</h2>
        </div>
        <div class="section-content">
          <ul class="pain-grid">
            <li class="pain-card" data-i18n="skillcertify-intro-item-01">채용 과정에서 실무에 바로 적용 가능한 기술을 가진 인재를 어떻게 확인할 수 있을지</li>
            <li class="pain-card" data-i18n="skillcertify-intro-item-02">많은 지원자와 사내 인재를 어떻게 효율적으로 평가하고 무수한 인재를 빠르게 선별할 수 있을지</li>
            <li class="pain-card" data-i18n="skillcertify-intro-item-03">개발자의 기술을 공정하고 편견 없이 평가할 방법이 없을지</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="deliverables product-feature is-sunken fade-up">
      <div class="section-wrap row">
        <div class="feature-copy">
          <p class="tag" data-i18n="skillcertify-deliverables-tag-01">프로젝트형 평가</p>
    ...
    <section class="deliverables product-feature fade-up">
      <div class="section-wrap row">
        <div class="feature-copy">
          <p class="tag" data-i18n="skillcertify-deliverables-tag-02">심층 다면 평가</p>
    ...
    <section class="deliverables product-feature is-sunken fade-up">
      <div class="section-wrap row">
        <div class="feature-copy">
          <p class="tag" data-i18n="skillcertify-deliverables-tag-03">기술 · 직무별 평가 콘텐츠</p>
    ...
    <section class="deliverables product-feature fade-up">
      <div class="section-wrap row">
        <div class="feature-copy">
          <p class="tag" data-i18n="skillcertify-deliverables-tag-04">AI 시험 감독 기능</p>
    ...
    <section class="process fade-up">
      <div class="section-wrap col">
        <div class="section-title text-center">
          <p class="tag" data-i18n="skillcertify-process-tag">2주 PoC</p>
          <h2 data-i18n="skillcertify-process-title">2주 안에 첫 리포트를 받아보세요</h2>
          <p class="desc" data-i18n="skillcertify-process-desc">작은 범위로 시작해 평가 적합성과 결과 활용 방식을 확인한 뒤, 도입 범위를 결정합니다.</p>
        </div>
        <div class="section-content">
          <ol class="cycle">
            <li>
            ...
            <li>
              ...
              <h3 data-i18n="skillcertify-process-item-title-05">리뷰 미팅</h3>
              <p class="description" data-i18n="skillcertify-process-item-desc-05">결과 활용과 도입 방안 협의</p>
            </li>
          </ol>
          <p class="poc-note" data-i18n="skillcertify-process-note">연간 계약 30% 할인(Professional 연간은 3개월 무료) · 구독+크레딧 모델 · Proctive 적용 시 초대당 1.5크레딧 · VAT 별도</p>
        </div>
      </div>
    </section>
    ...
    <section class="outcomes fade-up">
      <div class="section-wrap col">
        <div class="section-title text-center">
          <p class="tag" data-i18n="skillcertify-outcomes-tag">고객 사례</p>
          <h2 data-i18n="skillcertify-outcomes-title">채용부터 육성까지, 같은 기준을 사용합니다</h2>
        </div>
        <div class="section-content">
    ...
    <section class="faq fade-up">
      <div class="section-wrap col">
        <div class="section-title text-center">
          <p class="tag" data-i18n="skillcertify-faq-tag">FAQ</p>
          <h2 data-i18n="skillcertify-faq-title">도입 전에 많이 묻는 질문</h2>
        </div>
        <div class="section-content">
          <div class="faq-list">
            <details>
    ...
    <section class="cta-final fade-up">
      <div class="section-wrap col cta-final-inner">
        ...
        <p class="cta-final-desc" data-i18n="skillcertify-cta-final-desc">2주 PoC로 실제 직무 프로젝트와 첫 역량 리포트를 확인하세요.</p>
