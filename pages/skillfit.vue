...
<main class="skillfit">
    ...
    <section class="sub-hero">
      <div class="hero-wrap">
        <div class="sub-hero-copy">
          <p class="tag" data-i18n="skillfit-hero-eyebrow">Learn · AI 개인화 학습</p>
          <h1 class="hero-title">SkillFit</h1>
          <p class="hero-desc" data-i18n="skillfit-hero-desc-01">AI 인터뷰로, <br data-break="desktop">나에게 맞는 학습을 시작합니다.</p>
          <p class="hero-desc" data-i18n="skillfit-hero-desc-02">AI 인터뷰가 현재 수준과 보완할 스킬을 파악해, 필요한 학습 경로와 콘텐츠를 설계합니다. <br data-break="desktop">강의를 보는 데 그치지 않고 <strong>브라우저에서 직접 코드를 씁니다</strong>.</p>
        ...
        <ul class="hero-facts surface-glass" data-stat-reveal="">
          <li class="metric-card">
            ...
            <div>
              <div class="metric-card__value"><span class="num" data-target="51">0</span><span class="unit">개</span></div>
              <p class="metric-card__label text-label" data-i18n="skillfit-hero-fact-label-01">트랙 · 3단계 레벨</p>
            </div>
          </li>
          <li class="metric-card">
            <span class="hero-fact-icon icon-lg" aria-hidden="true">
            ...
            <div>
              <div class="metric-card__value"><span class="num" data-target="4">0</span><span class="unit">가지</span></div>
              <p class="metric-card__label text-label" data-i18n="skillfit-hero-fact-label-02">실력을 확인하는 과제 유형</p>
            </div>
          </li>
          <li class="metric-card">
            <span class="hero-fact-icon icon-lg" aria-hidden="true">
            ...
            <div>
              <div class="metric-card__value"><span class="num" data-target="0">0</span><span class="unit">개</span></div>
              <p class="metric-card__label text-label" data-i18n="skillfit-hero-fact-label-03">설치할 프로그램</p>
            </div>
          </li>
        </ul>
      </div>
    ...
    <!-- 문제 제기 — 뒤의 네 단계가 해결책으로 읽히게 하는 자리.
         한 줄짜리 카드로는 "문제"로 읽히지 않아 아이콘 + 소제목 변형(pain-card--detail)을 쓴다. -->
    <section class="intro fade-up">
      <div class="section-wrap col">
        <div class="section-title text-center">
          <h2 data-i18n="skillfit-intro-title">교육을 마쳐도, <br data-break="mobile">실력 변화는 확인하기 어렵습니다</h2>
          <p class="desc" data-i18n="skillfit-intro-desc">지금 기업 교육에서 반복되는 세 가지입니다.</p>
        </div>
        <div class="section-content">
          <ul class="pain-grid">
            <li class="pain-card pain-card--detail">
              ...
              <p data-i18n="skillfit-intro-item-desc-01">전원이 같은 강의를 듣습니다. 아는 사람은 지루하고, 모르는 사람은 따라가지 못합니다.</p>
            </li>
            <li class="pain-card pain-card--detail">
              <span class="pain-card__icon" aria-hidden="true">
              ...
              <p data-i18n="skillfit-intro-item-desc-02">누가 끝까지 들었는지는 집계되는데, 그것이 실력인지는 아무도 모릅니다.</p>
            </li>
            <li class="pain-card pain-card--detail">
              <span class="pain-card__icon" aria-hidden="true">
              ...
              <p data-i18n="skillfit-intro-item-desc-03">영상을 끝까지 본 사람과 실제로 코드를 쓸 수 있는 사람은 같지 않습니다.</p>
            </li>
          </ul>
        </div>
      </div>
    ...
    <!-- 학습자가 지나는 네 단계. 아래 세 섹션이 02~04를 하나씩 펼치므로 여기서는 흐름만 보여준다. -->
    <section class="journey is-sunken fade-up">
      <div class="section-wrap col">
        <div class="section-title text-center">
          <p class="tag" data-i18n="skillfit-journey-tag">학습 흐름</p>
          <h2 data-i18n="skillfit-journey-title">진단에서 학습 계획까지, 네 단계</h2>
          <p class="desc" data-i18n="skillfit-journey-desc">무엇을 모르는지 찾는 데서 시작해, 실제로 코드를 쓰고 피드백을 받는 데까지 이어집니다.</p>
        </div>
        <div class="section-content">
          <ol class="cycle">
            <li>
              <div class="cycle-head">
                ...
                <p class="cycle-en" data-i18n="skillfit-journey-item-en-01">Interview</p>
              </div>
            ...
            <li>
              <div class="cycle-head">
                ...
                <p class="cycle-en" data-i18n="skillfit-journey-item-en-02">Path</p>
              </div>
            ...
            <li>
              <div class="cycle-head">
                ...
                <p class="cycle-en" data-i18n="skillfit-journey-item-en-03">Practice</p>
              </div>
            ...
            <li>
              <div class="cycle-head">
                ...
                <p class="cycle-en" data-i18n="skillfit-journey-item-en-04">Tutor</p>
              </div>
              <h3 data-i18n="skillfit-journey-item-title-04">1:1 AI 튜터</h3>
              <p class="description" data-i18n="skillfit-journey-item-desc-04">부족한 이유와 다음 학습 방향을 알려줍니다</p>
            </li>
          </ol>
    ...
    <section class="deliverables product-feature fade-up">
      <div class="section-wrap row">
        <div class="feature-copy">
          <p class="tag" data-i18n="skillfit-deliverables-tag-01">맞춤 학습 경로</p>
          <h2 data-i18n="skillfit-deliverables-title-01">이미 아는 내용은 건너뜁니다</h2>
        ...
        <!-- 학습 홈 화면. 진단이 짠 경로가 "이어서 학습"으로 이어진다는 것만 읽히면 되므로
             그 카드와 수치 4칸만 텍스트로 남기고 나머지는 스켈레톤으로 가라앉힌다. -->
        <div class="content-panel bg">
          <div class="preview-frame preview-frame--flush skillfit-home" data-mock-motion="ticker" aria-hidden="true">
            <div class="preview-frame__bar">
              <span class="preview-frame__dots"><i></i><i></i><i></i></span>
            </div>

            <div class="skillfit-home-screen">
              <!-- 좌 — 학습 메뉴와 이어서 학습 진입점. -->
              <div class="skillfit-home-nav">
                <div class="skillfit-home-brand">
                  <span class="journey-app-rail-logo"></span>
                  <span class="journey-mock-item-name">Codepresso</span>
                </div>

                <ul class="skillfit-home-menu">
                  <li class="is-current">홈</li>
                  <li>트랙 탐색</li>
                  <li>학습 기록</li>
                </ul>

                <div class="skillfit-home-resume">
                  <span class="journey-app-track-name">AI 에이전트 활용</span>
                </div>

                <div class="skillfit-home-user">
                  <span class="journey-mock-avatar">진</span>
                  <span class="journey-app-level">Lv.13</span>
                </div>
              </div>

              <!-- 우 — 오늘의 학습 상태. -->
              <div class="skillfit-home-main">
                <p class="journey-app-lesson">오늘도 한 챕터 완주해볼까요?</p>

                <ul class="skillfit-home-stats">
                  <li><b class="is-pop">4<em>일</em></b></li>
                  <li><b class="is-pop">10</b></li>
                  <li><b class="is-pop">24<em>분</em></b></li>
                  <li><b class="is-pop">64</b></li>
                </ul>

                <div class="skillfit-home-continue">
                  <div class="skillfit-home-track">
                    <span class="journey-app-track-badge">학습중인 트랙</span>
                    <span class="journey-app-track-name">AI 에이전트 활용</span>
                    <span class="journey-app-progress-bar"><span style="width: 39%"></span></span>
                  </div>

                  <div class="skillfit-home-chapter">
                    <p class="journey-app-eyebrow">CHAPTER 8</p>
                    <p class="journey-mock-item-name">RICJ 프롬프트 프레임워크</p>
                    <div class="skeleton-stack">
                      <span class="skeleton-line"></span>
                      <span class="skeleton-line is-short"></span>
                    </div>
                    <span class="skillfit-mock-button">계속하기</span>
                  </div>
                </div>
              </div>
            </div>
    ...
    <!-- 51개 트랙 — hero 보조 CTA(트랙 둘러보기)가 도착하는 자리라 id를 준다. -->
    <section class="catalog is-sunken fade-up" id="skillfit-tracks">
      <div class="section-wrap col">
        <div class="section-title text-center">
          <p class="tag" data-i18n="skillfit-catalog-tag">트랙</p>
          <h2 data-i18n="skillfit-catalog-title">기본기부터 AI 시대 스택까지</h2>
    ...
    <section class="deliverables product-feature fade-up">
      <div class="section-wrap row">
        <div class="feature-copy">
          <p class="tag" data-i18n="skillfit-deliverables-tag-02">실습 환경</p>
          <h2 data-i18n="skillfit-deliverables-title-02">직접 코드를 쓰고 실행하며 배웁니다</h2>
        ...
        <!-- 학습 화면. index PART 1이 쓰는 skillfit-mock을 그대로 쓰되, 여기서는
             튜터 팝업 없이 실습 본문만 보여준다(튜터는 아래 04가 맡는다). -->
        <div class="content-panel bg">
          <div class="preview-frame preview-frame--flush skillfit-mock" data-mock-motion="focus" aria-hidden="true">
            <div class="preview-frame__bar">
              <span class="preview-frame__dots"><i></i><i></i><i></i></span>
            </div>

            <div class="skillfit-mock-screen">
              <!-- 최좌측 — 아이콘 메뉴 레일. index PART 1의 SkillFit 목업과 같은 부품이다. -->
              ...
              <div class="journey-app-side">
                <div class="journey-app-track">
                  ...
                  <span class="journey-app-level">입문</span>
                ...
                <ul class="journey-app-skills">
                  <li class="journey-app-skill is-done is-quiet">
                  ...
                  <li class="journey-app-skill is-current is-focus">
                    <span class="journey-app-num">8</span>
                    <span class="journey-mock-item-name">RICJ 프레임워크</span>
                  </li>
                  <li class="journey-app-skill is-quiet">
                    <span class="journey-app-num">9</span>
                    <span class="skeleton-line"></span>
              ...
              <div class="journey-app-main">
                ...
                <div class="skillfit-mock-lesson-meta">
                  ...
                  <p class="journey-app-adapt">코드 작성 <strong>2문항</strong></p>
                </div>
                ...
                <!-- 화면 안에서 다음 과제로 넘어간다는 신호. 실제 학습 화면의 하단 바다. -->
                <span class="skillfit-mock-button is-wide">다음</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="deliverables product-feature is-sunken fade-up">
      <div class="section-wrap row">
        <div class="feature-copy">
          <p class="tag" data-i18n="skillfit-deliverables-tag-03">1:1 AI 튜터</p>
          <h2 data-i18n="skillfit-deliverables-title-03">학습 중 궁금한 점은 바로 물어보세요</h2>
        ...
        <!-- AI 튜터 대화창. 03과 같은 학습 화면 위에서 열리는 패널이라
             부품(journey-app-tutor-* · journey-mock-bubble · journey-app-ask)을 그대로 쓴다. -->
        <div class="content-panel bg">
          <div class="preview-frame preview-frame--flush skillfit-tutor" aria-hidden="true">
            <div class="journey-app-tutor-head skillfit-tutor-head">
              ...
              <span class="skillfit-tutor-title">
                <b class="journey-app-tutor-name">AI 튜터</b>
              </span>
              <span class="journey-app-tutor-status">답변 완료</span>
            </div>
            ...
            <div class="skillfit-tutor-chat">
              ...
              <div class="journey-mock-bubble skillfit-tutor-answer is-chat" style="--mock-chat-step: 1">
                <b>RICJ 프레임워크란?</b>
                <p>AI가 엉뚱한 답을 하는 이유는 질문에 <strong>목적과 조건이 부족하기 때문</strong>입니다.
                  RICJ는 그 정보를 네 가지로 나누어 전달하는 방법입니다.</p>
                <ul class="skillfit-tutor-terms">
                  <li><b>Role</b> AI가 맡을 역할</li>
                  <li><b>Instruction</b> 해야 할 일</li>
                  <li><b>Context</b> 배경 정보</li>
                  <li><b>Judgement</b> 결과물의 판단 기준</li>
                </ul>
              </div>
            </div>

            <div class="skillfit-tutor-foot">
              <span class="journey-app-eyebrow">추천 질문 보기</span>
    ...
    <!-- 본문 중간 강조 1곳 — 변화 리포트. 기획서 3절 A안(먼저 만들고 쓴다)을 전제로 한 문구다. -->
    <section class="statement fade-up">
      <div class="section-wrap col">
        <div class="statement-inner">
          <p class="statement-eyebrow" data-i18n="skillfit-statement-eyebrow">변화 리포트</p>
          <h2 class="statement-title" data-i18n="skillfit-statement-title">학습 후, <strong>무엇이 달라졌는지 확인합니다</strong></h2>
          <p class="statement-desc" data-i18n="skillfit-statement-desc">시작할 때의 진단과 끝난 뒤의 재진단을 나란히 놓고, 어느 영역이 얼마나 올라갔는지 개인과 조직 단위로 확인합니다.</p>
        </div>
      </div>
    </section>

    <!-- 여기부터 독자가 학습자에서 교육 담당자로 바뀐다. -->
    <section class="features fade-up">
      <div class="section-wrap col">
        <div class="section-title text-center">
          <p class="tag" data-i18n="skillfit-features-tag">조직 운영</p>
          <h2 data-i18n="skillfit-features-title">담당자는 한 화면에서 학습 현황을 확인합니다</h2>
          <p class="desc" data-i18n="skillfit-features-desc">기수를 만들고 기간을 정하면 그 기간에만 학습이 열립니다.</p>
        </div>
        <div class="section-content">
          <div class="feature-card-grid">
            <article class="feature-card">
              ...
              <div class="section-body">
                <div class="section-body-heading">
                  <p class="section-body-title" data-i18n="skillfit-features-item-title-01">기수 관리</p>
                </div>
                <p class="section-body-subtitle" data-i18n="skillfit-features-item-subtitle-01">대상자와 기간을 <br> 기수 단위로 엽니다</p>
                <div class="feature-card-desc-row">
                  <div class="section-body-description">
                    <p data-i18n="skillfit-features-item-desc-01">명단과 기간을 정하면 그 기간에만 학습이 열리고, 종료와 함께 닫힙니다.</p>
                  </div>
                </div>
              </div>
            </article>
            ...
            <article class="feature-card">
              ...
              <div class="section-body">
                <div class="section-body-heading">
                  <p class="section-body-title" data-i18n="skillfit-features-item-title-02">진행 대시보드</p>
                </div>
                <p class="section-body-subtitle" data-i18n="skillfit-features-item-subtitle-02">조직 · 트랙 · 개인별 <br> 진행률과 점수를 확인합니다</p>
                <div class="feature-card-desc-row">
                  <div class="section-body-description">
                    <p data-i18n="skillfit-features-item-desc-02">구성원별 학습 진행 상황과 보완이 필요한 영역을 확인할 수 있습니다.</p>
                  </div>
                </div>
              </div>
            </article>
            ...
            <article class="feature-card">
              ...
              <div class="section-body">
                <div class="section-body-heading">
                  <p class="section-body-title">리포트</p>
                </div>
                <p class="section-body-subtitle">화면에서 확인하고 <br> 엑셀 파일로 내려받습니다</p>
                <div class="feature-card-desc-row">
                  <div class="section-body-description">
                    <p>기수가 끝나면 개인 리포트와 조직 요약을 함께 전달합니다.</p>
                  </div>
                </div>
              </div>
            </article>
    ...
    <!-- 도입 절차 — 담당자가 가장 궁금해하는 "우리가 뭘 해야 하나". 기간이 붙어 timeline. -->
    <section class="process fade-up">
      <div class="section-wrap col">
        <div class="section-title text-center">
          <p class="tag" data-i18n="skillfit-process-tag">도입 절차</p>
          <h2 data-i18n="skillfit-process-title">명단과 기간만 주시면 됩니다</h2>
          <p class="desc" data-i18n="skillfit-process-desc">체험 프로그램은 2~3주 한 기수로 진행하고, 종료와 함께 결과를 전달합니다.</p>
        </div>
        <div class="section-content">
          <ol class="timeline">
            <li>
              <span class="timeline__term" data-i18n="skillfit-process-item-term-01">신청 후 2일</span>
              <span class="timeline__marker" aria-hidden="true"></span>
              <div class="timeline__body">
                <h3 class="timeline__title" data-i18n="skillfit-process-item-title-01">기수 개설</h3>
                <p class="timeline__desc" data-i18n="skillfit-process-item-desc-01">대상자 명단과 학습 기간을 받아 기수를 만들고 계정을 준비합니다.</p>
              </div>
            </li>
            <li>
              <span class="timeline__term" data-i18n="skillfit-process-item-term-02">1일차</span>
              <span class="timeline__marker" aria-hidden="true"></span>
              <div class="timeline__body">
                <h3 class="timeline__title" data-i18n="skillfit-process-item-title-02">진단 인터뷰</h3>
                <p class="timeline__desc" data-i18n="skillfit-process-item-desc-02">학습자는 링크로 접속해 진단 인터뷰부터 시작합니다. 결과가 곧 학습 계획이 됩니다.</p>
              </div>
            </li>
            <li>
              <span class="timeline__term">2~3주</span>
              <span class="timeline__marker" aria-hidden="true"></span>
              <div class="timeline__body">
                <h3 class="timeline__title">학습과 실습</h3>
                <p class="timeline__desc">학습자는 계획대로 실습을 진행하고, 담당자는 대시보드로 진행 상황을 봅니다.</p>
              </div>
            </li>
            <li>
              <span class="timeline__term">종료 시</span>
              <span class="timeline__marker" aria-hidden="true"></span>
              <div class="timeline__body">
                <h3 class="timeline__title">리포트 전달</h3>
                <p class="timeline__desc">개인 리포트와 조직 요약을 전달하고, 다음 기수 범위를 함께 정합니다.</p>
              </div>
            </li>
          </ol>
        </div>
    ...
    <!-- FAQ — 마지막 질문(진단 정확도)은 피하지 않고 한계를 인정하는 편이 신뢰를 만든다. -->
    <section class="faq is-sunken fade-up">
      <div class="section-wrap col">
        <div class="section-title text-center">
          <p class="tag">FAQ</p>
          <h2>시작 전에 많이 묻는 질문</h2>
        </div>
        <div class="section-content">
          <div class="faq-list">
            <details>
    ...
    <!-- 최하단 전환 — hero와 같은 CTA를 반복한다 -->
    <section class="cta-final fade-up">
      <div class="section-wrap col cta-final-inner">
        <h2 class="cta-final-title">2~3주 뒤, 구성원의 실력 변화를 확인하세요</h2>
        <p class="cta-final-desc">대상자 명단과 기간만 알려주시면 기수를 만들어 드립니다.</p>
