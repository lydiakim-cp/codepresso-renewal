...
| Icon Size | `icon.css` | `.icon-sm`(20) · `.icon-md`(24) · `.icon-lg`(32) | **아이콘 크기는 이 세 클래스로만 정한다.** 감싼 span에 붙이면 안쪽 svg·img가 따라온다. 배경 있는 아이콘 박스(`--icon-box` 48 / `--icon-box-sm` 32)는 다른 개념이라 박스가 아니라 안쪽 그림에 붙인다 |
